<template>
  <div class="wrapper">
    ...
    <div class="main">
      ...
      <div class="imgbox">
        <img src="../assets/images/buy_mb_banner.png"/>
      </div>

      <div class="state">
        <div class="container">
          <div class="h2">中国慢性病高发</div>

          <div class="content">
            <div class="h3">慢病形势刻不容缓</div>
            <p class="desc">中国居民营养与慢性病状况报告2015<br/>每四人就有一人高血压 (25.3%)<br/>每十人就有一人糖尿病 (9.7%)</p>

            <div class="img"><img src="../assets/images/buy_mb_tj.png"/></div>
            ...
            <div class="viewpoint clearfix">
              ...
              <dl class="correct clearfix">
                ...
                <dd><em>正确的健康观：</em><br/>慢性病十分隐蔽而且很难治疗，一旦患病，带来终生困恼。慢性病防大于治！</dd>
              </dl>
            </div>
      ...
      <div class="forecast">
        <div class="container">
          <div class="h2">基因检测预知疾病风险，指导健康生活，预防疾病发生！</div>
          <div class="content">
            <div class="h3">己秘——常见慢性病风险预测</div>
